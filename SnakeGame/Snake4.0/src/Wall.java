...
public class Wall {
	...
	public static Image wallIcon;//墙相关图片
	static
	{
		try {
			wallIcon=ImageIO.read(new File("image\\wall.png"));
		} catch (IOException e) {
	...
	public void drawWall(Graphics canvas)//画出一个墙体
	{
		...
		canvas.drawImage(wallIcon,x-Snake.size/2, y-Snake.size/2, Snake.size, Snake.size,null);
	}
