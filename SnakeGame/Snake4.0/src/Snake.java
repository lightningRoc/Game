...
public class Snake {
	...
	private static Image bodyIcon;//蛇的身体
	private static Image headRIcon;//向右的头部
	private static Image headLIcon;//向左的头部
	private static Image headUIcon;//向上的头部
	private static Image headDIcon;//向下的头部
	static//获取图片
	{
		try {
	...
	public Snake()
	{
		...
		body.addLast(new Node(25,5));//初始赋予三个结点
	...
	public boolean hitWall(Node head)//判断是否撞墙
	{
